...
public class OrganizationUser
{
    ...
    public virtual ICollection<OrganizationPermission> Permissions { get; set; } = DefaultPermissions.OrganizationPermissions.Select(x => new OrganizationPermission { Permission = x }).ToList();
