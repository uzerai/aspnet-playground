...
namespace Dotnet.PlaygroundMigrations
{
    ...
    [Migration("20250507184553_AddSectorEntityAndRemoveNoteEntity")]
    partial class AddSectorEntityAndRemoveNoteEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dotnet.Playground.Model.Sector", b =>
                {
                    ...
                    b.HasIndex("CragId")
                        .HasDatabaseName("ix_sectors_crag_id");
            ...
            modelBuilder.Entity("Dotnet.Playground.Model.Sector", b =>
                {
                    b.HasOne("Dotnet.Playground.Model.Crag", "Crag")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sectors_crags_crag_id");
