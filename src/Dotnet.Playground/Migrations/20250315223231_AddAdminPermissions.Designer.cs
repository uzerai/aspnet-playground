...
namespace Dotnet.PlaygroundMigrations
{
    ...
    [Migration("20250315223231_AddAdminPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Authorization.Permissions.OrganizationPermission", b =>
                {
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.BaseEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Organizations.OrganizationTeamUser", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid")
                        .HasColumnName("organization_id");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Organizations.OrganizationUser", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid")
                        .HasColumnName("organization_id");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Authentication.User", b =>
                {
                    b.HasBaseType("Dotnet.PlaygroundModel.BaseEntity");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Organizations.Organization", b =>
                {
                    b.HasBaseType("Dotnet.PlaygroundModel.BaseEntity");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Organizations.OrganizationTeam", b =>
                {
                    b.HasBaseType("Dotnet.PlaygroundModel.BaseEntity");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Tags.Tag", b =>
                {
                    b.HasBaseType("Dotnet.PlaygroundModel.BaseEntity");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Tags.Taggable", b =>
                {
                    b.HasBaseType("Dotnet.PlaygroundModel.BaseEntity");
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Document", b =>
                {
                    b.HasBaseType("Dotnet.PlaygroundModel.Tags.Taggable");
            ...
            modelBuilder.Entity("TagTaggable", b =>
                {
                    b.HasOne("Dotnet.PlaygroundModel.Tags.Taggable", null)
                        .WithMany()
                    ...
                    b.HasOne("Dotnet.PlaygroundModel.Tags.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Authorization.Permissions.OrganizationPermission", b =>
                {
                    b.HasOne("Dotnet.PlaygroundModel.Organizations.Organization", "Organization")
                        .WithMany()
                    ...
                    b.HasOne("Dotnet.PlaygroundModel.Authentication.User", "User")
                        .WithMany()
                    ...
                    b.HasOne("Dotnet.PlaygroundModel.Organizations.OrganizationUser", "OrganizationUser")
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Organizations.OrganizationTeamUser", b =>
                {
                    ...
                    b.HasOne("Dotnet.PlaygroundModel.Organizations.OrganizationTeam", "OrganizationTeam")
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Tags.Tag", b =>
                {
                    b.HasOne("Dotnet.PlaygroundModel.Authentication.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Dotnet.PlaygroundModel.Document", b =>
                {
                    b.HasOne("Dotnet.PlaygroundModel.Authentication.User", "Author")
                        .WithMany()
